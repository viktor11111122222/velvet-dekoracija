...
let _scrollY = 0;
let _lightboxReturnGallery = null;
...
function closeLightbox() {
  ...
  if (_lightboxReturnGallery) {
    const key = _lightboxReturnGallery;
    _lightboxReturnGallery = null;
    unlockScroll();
    openSvcGallery(key);
  } else {
    unlockScroll();
...
const SERVICE_GALLERIES = {
  ...
  vencanje: [
    ...
    'public/vencanje/image00022.webp',
    'public/vencanje/20251025_140409.webp',
    'public/vencanje/IMG-ca5ee3557241d3ca7d196153651edd67-V.webp',
    'public/vencanje/IMG-8f3e49bc5f16ce9936541987244232ab-V.webp',
    'public/vencanje/SM__3438_c811e084-c315-4fb7-bb2a-f5b89a81e320.webp',
    'public/vencanje/IMG-c288bc8365e273e43d725832800d28e6-V.webp',
...
(function () {
  ...
  const PREVIEW_PICKS = [
    { key: 'vencanje',     src: 'public/vencanje/PFactory_0604.webp' },
